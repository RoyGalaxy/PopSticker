  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <input type="email" placeholder='example@mail.com' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
      ...
      <div className="mt-2.5">
        ...
        <div className='mt-16'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('razorpay')} className={`flex items-center gap-3 border p-2 px-3 cursor-pointer  ${method === 'razorpay' ? 'border-green-500' : ''}`}>
          ...
          <div className="w-full flex text-end mt-8 justify-start">
            <button onClick={() => navigate('/orders')} className="bg-black text-white px-16 py-3 text-sm sm:text-base w-full sm:w-auto">PLACE ORDER</button>
          </div>
