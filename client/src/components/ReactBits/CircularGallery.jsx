...
class Media {
  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        // Blend background color with image (if alpha < 1, mix background)
        vec4 finalColor = mix(vec4(uBgColor, 1.0), imageColor, imageColor.a);
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = ((this.viewport.height * (900 * this.scale)) / this.screen.height) * scaleFactor
    this.plane.scale.x = ((this.viewport.width * (700 * this.scale)) / this.screen.width) * scaleFactor
